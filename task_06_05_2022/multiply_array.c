#include <stdio.h>
#include <stdbool.h>
bool mul_of_array(int first_array[], int second_array[], int len_first_array, int len_second_array, int mul_array[], int len_third_array)
{
    ...
    {
        mul_array[k] = first_array[i] * second_array[j];
    }
    return true;
}
...
int main()
{
    ...
    printf("The multiply of two arrays is:\n");
    mul_of_array(first_array, second_array, len_first_array, len_second_array, mul_array, len_third_array);
    array_print(mul_array, len_third_array);
    printf("\n");
    return 0;
}
